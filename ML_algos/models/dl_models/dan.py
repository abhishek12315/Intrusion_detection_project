...
class Classifier:
    ...
    def run(self):
        X_train, X_test, y_train, y_test = data_utils.load_train_test_data(self.data_fname, is_raw=False, max_seq_len=self.para['max_seq_len'])
...
if __name__ == '__main__':
    ...
    para = {'learning_rate': 0.0005, 'l2_reg': 1e-4, 'hidden_size': 300, 'max_seq_len': 500, 'epoch_num': 25,
